...
const Navbar = () => {
  return (
    ...
    <nav class="border-gray-200 bg-darkColor dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="" class="h-8" alt="Flowbite Logo" />
            <span class="text-white self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
        </a>
        ...
        <div className='hidden flex flex-col items-end id="navbar-default"'>
            <p className='text-green-500'>Call Us!</p>
            <p className='text-white'>+91  - 7676767676</p>
        </div>
      </div>
    </nav>
